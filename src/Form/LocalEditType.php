...
class LocalEditType extends AbstractType
{
        ...
        $builder
            ->add('consitance', ChoiceType::class, [
                ...
                'choices' => ['Appartement' => 'Appartement', 'Studio' => 'Studio',
                    'Chambre' => 'Chambre','Magasin' => 'Magasin','Boutique' => 'Boutique', ],'attr'=>['class' => 'form-control','']])
          ...
          /*  ->add('number',IntegerType::class, [
            ...
            ->add('status', ChoiceType::class, [
                ...
                'choices' => ['Disponible' => 'disponible', ' En travaux' => 'travaux',
                    'Occupé' => 'occupe', ],'attr'=>['class' => 'form-control','']])
